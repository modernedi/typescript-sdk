...
export interface IntegrationPartner {
     ...
     * @type {IntegrationPartnerUnmappedInboundPolicyEnum}
     * @memberof IntegrationPartner
     */
    unmappedInboundPolicy: IntegrationPartnerUnmappedInboundPolicyEnum;
    /**
     * Tenant certificate slot ModernEDI uses to sign AS2 traffic for this partner.
     * @type {IntegrationPartnerSigningCertificateSlotEnum}
     * @memberof IntegrationPartner
     */
    signingCertificateSlot: IntegrationPartnerSigningCertificateSlotEnum;
    /**
 ...
 * @export
 */
export const IntegrationPartnerUnmappedInboundPolicyEnum = {
    MappedOnly: 'MAPPED_ONLY',
    PassthroughRawX12: 'PASSTHROUGH_RAW_X12',
    UnknownDefaultOpenApi: '11184809'
} as const;
export type IntegrationPartnerUnmappedInboundPolicyEnum = typeof IntegrationPartnerUnmappedInboundPolicyEnum[keyof typeof IntegrationPartnerUnmappedInboundPolicyEnum];

/**
 * @export
 */
export const IntegrationPartnerSigningCertificateSlotEnum = {
    Active: 'active',
    Next: 'next',
    UnknownDefaultOpenApi: '11184809'
} as const;
export type IntegrationPartnerSigningCertificateSlotEnum = typeof IntegrationPartnerSigningCertificateSlotEnum[keyof typeof IntegrationPartnerSigningCertificateSlotEnum];


/**
 * Check if a given object implements the IntegrationPartner interface.
 */
export function instanceOfIntegrationPartner(value: object): value is IntegrationPartner {
...
export function IntegrationPartnerFromJSON(json: any): IntegrationPartner {
    return IntegrationPartnerFromJSONTyped(json, false);
}

export function IntegrationPartnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): IntegrationPartner {
    if (json == null) {
        return json;
    }
    return {
...
export function IntegrationPartnerToJSON(json: any): IntegrationPartner {
    return IntegrationPartnerToJSONTyped(json, false);
}

export function IntegrationPartnerToJSONTyped(value?: IntegrationPartner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
