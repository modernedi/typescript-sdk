...
/**
 * Check if a given object implements the As2PartnerEnvironment interface.
 */
export function instanceOfAs2PartnerEnvironment(value: object): value is As2PartnerEnvironment {
...
export function As2PartnerEnvironmentFromJSON(json: any): As2PartnerEnvironment {
    return As2PartnerEnvironmentFromJSONTyped(json, false);
}

export function As2PartnerEnvironmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): As2PartnerEnvironment {
    if (json == null) {
        return json;
    }
    return {
        ...
        'requireEncryption': json['requireEncryption'] == null ? undefined : json['requireEncryption'],
    };
}

export function As2PartnerEnvironmentToJSON(json: any): As2PartnerEnvironment {
    return As2PartnerEnvironmentToJSONTyped(json, false);
}

export function As2PartnerEnvironmentToJSONTyped(value?: As2PartnerEnvironment | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
